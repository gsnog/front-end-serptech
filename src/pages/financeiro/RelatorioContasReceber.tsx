...
import {
  fetchClientes, fetchContasBancarias, fetchPlanoContas,
  clientesQueryKey, contasBancariasQueryKey, planoContasQueryKey,
...
export default function RelatorioContasReceber() {
  ...
  const handleGerar = async () => {
    ...
    try {
      ...
      const response = await api.get("/api/financial/relatorio-contas-receber/", {
        params,
        responseType: "blob",
      })
  ...
  const handleVoltar = () => navigate("/financeiro/contas-receber")

  return (
    <SimpleFormWizard title="Relatório Contas a Receber">
