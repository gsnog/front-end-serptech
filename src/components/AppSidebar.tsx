...
const menuItems = [
  ...
  },
  {
    ...
    basePath: "/financeiro",
    module: "financeiro",
    help: "Módulo financeiro: saídas/entradas financeiras, fluxo de caixa e XML.",
    subItems: [
      { title: "Conciliação Bancária", url: "/financeiro/conciliacao-bancaria" },
      { title: "Entradas Financeiras", url: "/financeiro/contas-receber" },
      { title: "Saídas Financeiras", url: "/financeiro/contas-pagar" },
